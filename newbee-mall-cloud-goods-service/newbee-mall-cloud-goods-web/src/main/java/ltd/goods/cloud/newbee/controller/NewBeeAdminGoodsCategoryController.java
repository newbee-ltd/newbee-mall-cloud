...
public class NewBeeAdminGoodsCategoryController {
    ...
    public Result list(@RequestParam(required = false) @Parameter(description = "页码") Integer pageNumber,
                       ...
                       @RequestParam(required = false) @Parameter(description = "上级分类的id") Long parentId, @TokenToAdminUser @Parameter(hidden = true) LoginAdminUser adminUser) {
    ...
    public Result listForSelect(@RequestParam("categoryId") Long categoryId, @TokenToAdminUser @Parameter(hidden = true) LoginAdminUser adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
    ...
    public Result save(@RequestBody @Valid GoodsCategoryAddParam goodsCategoryAddParam, @TokenToAdminUser @Parameter(hidden = true) LoginAdminUser adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
    ...
    public Result update(@RequestBody @Valid GoodsCategoryEditParam goodsCategoryEditParam, @TokenToAdminUser @Parameter(hidden = true) LoginAdminUser adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
        GoodsCategory goodsCategory = new GoodsCategory();
