...
@Configuration
public class RecommendServiceSpringDocConfig {

    // 扫描路径
    private static final String basePackage = "ltd.recommend.cloud.newbee.controller";
    // 请求头名称
    private static final String headerName = "token";

    @Bean
    public GroupedOpenApi recommendGroup() {
